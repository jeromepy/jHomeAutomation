...
class BME280(object):
    ...
    def setDevice(self, deviceHex):
        # set the device in hex code (normally 0x77 or 0x70)
        self.DEVICE = int(deviceHex, 16)
        print("METEO_BME280: Device set to: " + deviceHex)

    def setSensorName(self, sensName):
        self.sensorName = sensName
